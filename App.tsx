...
export default function App() {
  ...
  // Autoseleccionar cuenta origen en Gasto según medio de pago
  useEffect(() => {
            ...
            <div className='card'>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                ...
                <div>
                  ...
                  <input type='text' inputMode='numeric' pattern='[0-9.,]*' placeholder='0' value={form.amount} onFocus={() => form.amount==='0' && onChange('amount','')} onBlur={() => (form.amount==='' || form.amount==null) && onChange('amount','0')} onChange={(e)=>onChange('amount', e.target.value)} />
                </div>
              </div>
